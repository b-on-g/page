...
;
	...
	($mol_mem(($.$bog_page_textarea_edit.prototype), "paste"));
...
;
	($.$bog_page_side) = class $bog_page_side extends ($.$mol_page) {
		...
		Edit_view(){
			const obj = new this.$.$bog_page_textarea();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_page_side_Edit_view_hint")));
			(obj.value) = (next) => ((this.body_text(next)));
			(obj.paste) = (next) => ((this.paste_image(next)));
			return obj;
		}
		View_wrap(){
			const obj = new this.$.$mol_view();
			(obj.event) = () => ({"click": (next) => (this.start_edit(next))});
			(obj.sub) = () => ([(this.Render())]);
			return obj;
		}
		tools(){
	...
	($mol_mem(($.$bog_page_side.prototype), "paste_image"));
	($mol_mem(($.$bog_page_side.prototype), "start_edit"));
	...
	($mol_mem(($.$bog_page_side.prototype), "View_wrap"));
...
;
	($.$bog_page_app) = class $bog_page_app extends ($.$mol_view) {
		Theme(){
		...
		Page_icon(id){
			const obj = new this.$.$mol_icon_text();
			return obj;
		}
		page_title(id){
			return "";
		...
		auto(){
			return [(this.ensure_default_page())];
		}
		sub(){
			return [(this.Sidebar()), (this.Editor_page())];
		}
		Create_item(){
			const obj = new this.$.$bog_ui_sidebar_item();
			(obj.Icon) = () => ((this.Create_icon()));
			(obj.label) = () => ((this.$.$mol_locale.text("$bog_page_app_Create_item_label")));
			(obj.click) = (next) => ((this.create(next)));
			return obj;
		}
		Page_item(id){
			const obj = new this.$.$bog_ui_sidebar_item();
			(obj.Icon) = () => ((this.Page_icon(id)));
			(obj.label) = () => ((this.page_title(id)));
			(obj.active) = () => ((this.page_active(id)));
			(obj.click) = (next) => ((this.open_page(id, next)));
			return obj;
		}
	};
	($mol_mem(($.$bog_page_app.prototype), "Theme"));
	($mol_mem(($.$bog_page_app.prototype), "Sidebar"));
	($mol_mem(($.$bog_page_app.prototype), "back_to_list"));
	($mol_mem(($.$bog_page_app.prototype), "Editor_page"));
	($mol_mem(($.$bog_page_app.prototype), "Create_icon"));
	($mol_mem(($.$bog_page_app.prototype), "create"));
	($mol_mem_key(($.$bog_page_app.prototype), "Page_icon"));
	($mol_mem_key(($.$bog_page_app.prototype), "open_page"));
	($mol_mem(($.$bog_page_app.prototype), "Create_item"));
	($mol_mem_key(($.$bog_page_app.prototype), "Page_item"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $bog_page_app.prototype, "ensure_default_page", null);
        __decorate([
            $mol_action
