...
declare namespace $.$$ {
    class $bog_blitz_lobby_players extends $.$bog_blitz_lobby_players {
        ...
        player_avatar(key: string): $.$mol_image | $.$mol_avatar;
        player_avatar_content(key: string): $.$mol_image | $.$mol_button_open | $.$mol_avatar;
...
declare namespace $.$$ {
    class $bog_blitz_lobby_join extends $.$bog_blitz_lobby_join {
        avatar_preview(): $.$mol_image | $.$mol_avatar;
        avatar_uri(): string;
        join_title(): string;
    }
}
...
declare namespace $.$$ {
    class $bog_feedback2_form extends $.$bog_feedback2_form {
        ...
        submit(): void;
        body(): $.$mol_paragraph[] | $.$mol_status[] | ($.$mol_text | $.$mol_string | $.$mol_textarea | $mol_button_major | $.$mol_section)[];
        all_lords(): string[];
...
declare namespace $.$$ {
    class $bog_page_app extends $.$bog_page_app {
        ...
        ensure_default_page(): null;
        sidebar_items(): $mol_view[];
        page_entry(key: string): $bog_page_entry | undefined;
        page_title(key: string): string;
        page_active(key: string): boolean;
