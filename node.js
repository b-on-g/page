...
;
	($.$bog_page_card) = class $bog_page_card extends ($.$mol_list) {
		open(next){
			if(next !== undefined) return next;
			return null;
		}
		...
		Delete(){
			...
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_page_card_Delete_hint")));
			(obj.sub) = () => ([(this.Delete_icon())]);
			return obj;
		}
		Row(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Open()), (this.Delete())]);
			return obj;
		}
		page_title(){
			return "";
	...
	($mol_mem(($.$bog_page_card.prototype), "open"));
	($mol_mem(($.$bog_page_card.prototype), "Title_label"));
	($mol_mem(($.$bog_page_card.prototype), "Open"));
	($mol_mem(($.$bog_page_card.prototype), "delete"));
	($mol_mem(($.$bog_page_card.prototype), "Delete_icon"));
	($mol_mem(($.$bog_page_card.prototype), "Delete"));
	($mol_mem(($.$bog_page_card.prototype), "Row"));
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($bog_page_card, {
            display: 'block',
        });
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_page_side) = class $bog_page_side extends ($.$mol_page) {
		paste_listener(){
			return null;
		}
		body_text(next){
		...
		Title_field(){
			...
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_page_side_Title_field_hint")));
			return obj;
		}
		editing(next){
			if(next !== undefined) return next;
		...
		Edit_toggle(){
			...
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_page_side_Edit_toggle_hint")));
		...
		Copy_md(){
			const obj = new this.$.$mol_button_copy();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_page_side_Copy_md_title")));
			(obj.text) = () => ((this.body_text()));
			return obj;
		}
		Copy_html(){
			const obj = new this.$.$mol_button_copy();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_page_side_Copy_html_title")));
			(obj.html) = () => ((this.body_html()));
			return obj;
		}
		download_name(){
			return "page.mt";
		...
		Download(){
			...
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_page_side_Download_title")));
		...
		Export(){
			...
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_page_side_Export_hint")));
		...
		Back(){
			...
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_page_side_Back_hint")));
		...
		Edit_view(){
			...
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_page_side_Edit_view_hint")));
			(obj.value) = (next) => ((this.body_text(next)));
			return obj;
		}
		Render(){
			const obj = new this.$.$mol_text();
	...
	($mol_mem(($.$bog_page_side.prototype), "body_text"));
	($mol_mem(($.$bog_page_side.prototype), "Title_field"));
	($mol_mem(($.$bog_page_side.prototype), "editing"));
	($mol_mem(($.$bog_page_side.prototype), "Edit_icon"));
	($mol_mem(($.$bog_page_side.prototype), "Edit_toggle"));
	($mol_mem(($.$bog_page_side.prototype), "Export_icon"));
	($mol_mem(($.$bog_page_side.prototype), "Copy_md"));
	($mol_mem(($.$bog_page_side.prototype), "Copy_html"));
	($mol_mem(($.$bog_page_side.prototype), "download_blob"));
	($mol_mem(($.$bog_page_side.prototype), "Download"));
	($mol_mem(($.$bog_page_side.prototype), "Export"));
	($mol_mem(($.$bog_page_side.prototype), "back"));
	($mol_mem(($.$bog_page_side.prototype), "Back_icon"));
	($mol_mem(($.$bog_page_side.prototype), "Back"));
	($mol_mem(($.$bog_page_side.prototype), "title"));
	($mol_mem(($.$bog_page_side.prototype), "Edit_view"));
	($mol_mem(($.$bog_page_side.prototype), "Render"));
    ...
    (function ($$) {
        class $bog_page_side extends $.$bog_page_side {
            entry() {
                ...
                return land.Data($bog_page_entry);
            }
            title(next) {
                const e = this.entry();
                if (!e)
            ...
            body_node() {
                return this.Edit_view().Edit().dom_node();
            }
            paste_listener() {
                if (!this.editing())
                    return null;
                const node = this.body_node();
                const handler = (e) => this.paste_image(e);
        ...
        __decorate([
            $mol_mem
        ], $bog_page_side.prototype, "entry", null);
        __decorate([
            $mol_mem
        ], $bog_page_side.prototype, "title", null);
        __decorate([
            $mol_mem
        ], $bog_page_side.prototype, "body_text", null);
        __decorate([
            $mol_mem
        ], $bog_page_side.prototype, "body_html", null);
        __decorate([
            $mol_mem
        ], $bog_page_side.prototype, "download_blob", null);
        __decorate([
            $mol_mem
        ], $bog_page_side.prototype, "download_name", null);
        __decorate([
            $mol_mem
        ], $bog_page_side.prototype, "paste_listener", null);
        __decorate([
            $mol_mem
        ], $bog_page_side.prototype, "body_view", null);
        $$.$bog_page_side = $bog_page_side;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_page_app) = class $bog_page_app extends ($.$mol_page) {
		Sources(){
			const obj = new this.$.$mol_link_source();
			(obj.uri) = () => ("https://github.com/b-on-g/page");
			return obj;
		}
		Status(){
		...
		Create(){
			...
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_page_app_Create_title")));
			(obj.click) = (next) => ((this.create(next)));
			return obj;
		}
		Empty_hint(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_page_app_Empty_hint_title")));
			return obj;
		}
		page_rows(){
			return [];
		...
		title(){
			return (this.$.$mol_locale.text("$bog_page_app_title"));
		}
		Title(){
			return null;
		}
		...
		Home(){
			...
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_page_app_Home_title")));
			(obj.tools) = () => ([(this.Create())]);
			(obj.body) = () => ([(this.Empty_hint()), (this.Pages_list())]);
			return obj;
		}
		Page_card(id){
			const obj = new this.$.$bog_page_card();
			(obj.page_title) = () => ((this.page_title(id)));
			(obj.open) = (next) => ((this.open_page(id, next)));
			(obj.delete) = (next) => ((this.delete_page(id, next)));
			return obj;
		}
		Editor(id){
			const obj = new this.$.$bog_page_side();
			(obj.page_link) = () => ((this.current_page_link()));
			(obj.back) = (next) => ((this.back_to_list(next)));
			return obj;
		}
	};
	($mol_mem(($.$bog_page_app.prototype), "Sources"));
	($mol_mem(($.$bog_page_app.prototype), "Status"));
	($mol_mem(($.$bog_page_app.prototype), "Theme_toggle"));
	($mol_mem(($.$bog_page_app.prototype), "Theme"));
	($mol_mem(($.$bog_page_app.prototype), "create"));
	($mol_mem(($.$bog_page_app.prototype), "Create"));
	($mol_mem(($.$bog_page_app.prototype), "Empty_hint"));
	($mol_mem(($.$bog_page_app.prototype), "Pages_list"));
	($mol_mem_key(($.$bog_page_app.prototype), "open_page"));
	($mol_mem_key(($.$bog_page_app.prototype), "delete_page"));
	($mol_mem(($.$bog_page_app.prototype), "back_to_list"));
	($mol_mem(($.$bog_page_app.prototype), "Home"));
	($mol_mem_key(($.$bog_page_app.prototype), "Page_card"));
	($mol_mem_key(($.$bog_page_app.prototype), "Editor"));
...
var $;
(function ($) {
    class $bog_page_entry extends $giper_baza_dict.with({
        Title: $giper_baza_atom_text,
    ...
    $.$bog_page_entry = $bog_page_entry;
    class $bog_page_registry extends $giper_baza_entity.with({
        Pages: $giper_baza_list_link_to(() => $bog_page_entry),
    }) {
    }
    $.$bog_page_registry = $bog_page_registry;
    class $bog_page_store extends $mol_object {
        glob() {
        ...
        registry() {
            return this.home_land().Data($bog_page_registry);
        }
    }
    $.$bog_page_store = $bog_page_store;
})($ || ($ = {}));
        ...
        class $bog_page_app extends $.$bog_page_app {
            ...
            screen_body() {
                if (this.current_page_link())
                    return [this.Editor(this.current_page_link())];
                const list = this.page_links();
                if (!list.length)
                    return [this.Empty_hint(), this.Pages_list()];
            ...
            page_entry(key) {
                return this.page_links()[Number(key)];
            }
            page_title(key) {
            ...
            back_to_list() {
                this.current_page_link(null);
            }
        }
        __decorate([
            $mol_mem
        ], $bog_page_app.prototype, "store", null);
        __decorate([
            $mol_mem
        ], $bog_page_app.prototype, "registry", null);
        __decorate([
            $mol_mem
        ], $bog_page_app.prototype, "current_page_link", null);
        __decorate([
            $mol_mem
        ], $bog_page_app.prototype, "page_links", null);
        __decorate([
            $mol_mem
        ], $bog_page_app.prototype, "screen_body", null);
        __decorate([
            $mol_mem
        ], $bog_page_app.prototype, "page_rows", null);
        __decorate([
            $mol_action
        ], $bog_page_app.prototype, "open_page", null);
        __decorate([
            $mol_action
        ], $bog_page_app.prototype, "delete_page", null);
        __decorate([
            $mol_action
        ], $bog_page_app.prototype, "create", null);
        __decorate([
            $mol_action
        ], $bog_page_app.prototype, "back_to_list", null);
        $$.$bog_page_app = $bog_page_app;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
